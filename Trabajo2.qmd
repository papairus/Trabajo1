...
Por último, a manera de crítica, cometimos un error metodológico especificamente en la Figura 6, al profundizar en la variable PG_autoestima en lugar de PH_depresión, ya que esta última presentaba una mayor riqueza analítica. La escala de depresión no solo tenía un mayor número de ítems, lo que permite una mejor consistencia interna y sensibilidad en la medición, sino que además se encuentra más directamente vinculada a la experiencia subjetiva de malestar psicológico, eje central del problema de investigación. Este desajuste redujo la capacidad explicativa del análisis y limitó la posibilidad de explorar con mayor profundidad las relaciones entre victimización y salud mental. Para futuros estudios, sería recomendable priorizar el análisis de variables con mayor robustez psicométrica y pertinencia teórica en función del objetivo planteado.
