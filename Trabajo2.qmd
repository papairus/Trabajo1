...
La Figura 5 presenta una matriz de correlación mixta que permite explorar las asociaciones entre variables de distinta naturaleza: continuas y discretas. Esta matriz combina coeficientes de correlación de Pearson para variables continuas, medidas de asociación para variables categóricas y gráficos de dispersión con líneas de tendencia para facilitar la visualización.v

Se puede apreciar que hay una relación positiva entre la escala de baja autoestima (*PG_autoestima*) y la escala de depresión (*PH_depresion*). Esto significa que, cuando las personas tienen más síntomas depresivos, también tienden a tener una autoestima más baja —recordando que ambas variables están codificadas de forma que un puntaje más alto entienda un menor bienestar— .

El **índice de victimizaciones** se creó sumando 31 preguntas de sí o no, donde las personas indican si han vivido alguna situación de violencia o victimización al menos una vez, por lo tanto, comprendemos que, hay una relación negativa con las dos escalas: mientras más victimizaciones se reportan, más alta es la depresión y más baja la autoestima.

Es importante tener en cuenta que no todas las variables son del mismo tipo (algunas son continuas, otras son sumas de respuestas sí/no), por lo tanto, no todas las relaciones deben interpretarse igual. Aun así, esta matriz ayuda a tener una idea general de cómo se conectan las variables entre sí.
